...
namespace WPF3D.ToolBox
{
    public static class MathUtils
    {
        ...
        private static Matrix3D GetProjectionMatrix(PerspectiveCamera camera, double aspectRatio)
        {
            ...
            double m33 = (double.IsPositiveInfinity(zf)) ? -1 : (zf / (zn - zf));
            double m43 = zn * m33;
        ...
        /// </returns>
        /// <exception cref="System.ArgumentException">Must be of type Visual3D.</exception>
